...
import static com.android.systemui.qs.QSPanel.QQS_SHOW_BRIGHTNESS_SLIDER;
...
public class QuickQSPanelController extends QSPanelControllerBase<QuickQSPanel> {
    ...
    QuickQSPanelController(
        ...
        mBrightnessSliderController = brightnessSliderFactory.create(getContext(),
                                                                     mView);
    ...
    protected void onViewAttached() {
        ...
        mTunerService.addTunable(mView, QQS_SHOW_BRIGHTNESS_SLIDER);
